...
<html>
    ...
    <body>
        ...
        <c:url var="action" value="/doctortreatment/indoor"/>
        ...
        <h2><spring:message code="label.outdoorHeading"/></h2>
        <form:form method="post" action="/doctortreatment/outdoor" commandName="outdoor">
            <table>
                <tr>
                    <td> 
